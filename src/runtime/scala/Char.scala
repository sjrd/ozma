...
object Char extends AnyValCompanion {
   ...
   */
  @native def box(x: Char): java.lang.Character = java.lang.Character.valueOf(x)
   ...
   */
  @native def unbox(x: java.lang.Object): Char = x.asInstanceOf[java.lang.Character].charValue()
