...
object Double extends AnyValCompanion {
   ...
   */
  @native def box(x: Double): java.lang.Double = java.lang.Double.valueOf(x)
   ...
   */
  @native def unbox(x: java.lang.Object): Double = x.asInstanceOf[java.lang.Double].doubleValue()
