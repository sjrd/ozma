...
object Boolean extends AnyValCompanion {
   ...
   */
  @native def box(x: Boolean): java.lang.Boolean = java.lang.Boolean.valueOf(x)
   ...
   */
  @native def unbox(x: java.lang.Object): Boolean = x.asInstanceOf[java.lang.Boolean].booleanValue()
